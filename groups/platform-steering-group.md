...
* work with the [Ecosystem Steering Group](https://www.swift.org/ecosystem-steering-group/) to improve the experience of setting up a Swift development environment on all supported platforms,
* work with the [Language Steering Group](https://www.swift.org/language-steering-group/) to define Swift language support in specific environments,
...
- Saleem Abdulrasool, Core Team Representative & member ([@compnerd](https://github.com/compnerd))
- Alastair Houghton, Chair ([@al45tair](https://github.com/al45tair))
- Danielle Lancashire ([@endocrimes](https://github.com/endocrimes))
- Frederic Riss ([@fredriss](https://github.com/fredriss))
- Kuba Mracek ([@kubamracek](https://github.com/kubamracek))
- Rokhini Prabhu ([@rokhinip](https://github.com/rokhinip))
...
All of these are under the purview of the [Ecosystem Steering Group](https://www.swift.org/ecosystem-steering-group/).
