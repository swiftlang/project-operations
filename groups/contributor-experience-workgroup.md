...
- Alex Hoppen ([@ahoppen](https://github.com/ahoppen))
- Anthony Latsis ([@AnthonyLatsis](https://github.com/AnthonyLatsis))
- Devanshi Modha, Diversity in Swift champion ([@devanshimodha](https://github.com/devanshimodha))
- Egor Zhdan ([@egorzhdan](https://github.com/egorzhdan))
- Harshita Pathipati ([@harshitapath](https://github.com/harshitapath))
- Holly Borla ([@hborla](https://github.com/hborla))
- James Dempsey ([@dempseyatgithub](https://github.com/dempseyatgithub))
- Joseph Heck ([@heckj](https://github.com/heckj))
- Karen Chu ([@karenhchu](https://github.com/karenhchu))
- Luciano Almeida ([@LucianoPAlmeida](https://github.com/LucianoPAlmeida))
- Mishal Shah ([@shahmishal](https://github.com/shahmishal))
- Paris Pittman ([@parispittman](https://github.com/parispittman))
- Pavel Yaskevich, Chair ([@xedin](https://github.com/xedin))
- Sam Khouri ([@bkhouri](https://github.com/bkhouri))
- Suyash Srijan ([@theblixguy](https://github.com/theblixguy))
- Timirah James ([@timirahj](https://github.com/timirahj))

We are grateful for the service of the following emeritus workgroup member:

- Max Desiatov ([@MaxDesiatov](https://github.com/MaxDesiatov))
