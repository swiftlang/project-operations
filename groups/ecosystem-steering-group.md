...
- work with the [Platforms Steering Group](https://www.swift.org/platform-steering-group/) to improve the experience of setting up
  a Swift development environment on all supported platforms,
- work with the [Language Steering Group](https://www.swift.org/language-steering-group/) to create resources on best practices
...
All of these are under the purview of the [Language Steering Group](https://www.swift.org/language-steering-group/) or
...
- [The Server Workgroup](https://www.swift.org/sswg/)
- [The Documentation Workgroup](https://www.swift.org/documentation-workgroup/)
- [The Foundation Workgroup](https://www.swift.org/foundation-workgroup/)
- [The Testing Workgroup](https://www.swift.org/testing-workgroup/)
...
Conduct](https://www.swift.org/code-of-conduct/). Instances of abusive,
