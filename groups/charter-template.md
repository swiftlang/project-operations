...
The *[Group Name]* is a *[summary of the goals, what it does, e.g., "guides the evolution of Swift on platforms beyond Apple ecosystems"*].

_This section expands on the responsibilities, goals, and guiding principles of the group._

- [Goal 1]
- [Goal 2]
- [Goal 3]

_This section details the repositories that the group manages, oversees, maintains, etc_
- [Repo 1]
- [Repo 2]
...
- Time commitment
- Contribution expectations (e.g., attending meetings, reviewing proposals)
-->

### Current Members

- *Name (@forumhandle/ @github_handle)* <!-- Mention Chair -->
- *Name (@forum_handle/ @github_handle)*
- ...*
...
Everyone is welcome to participate. Ways to get involved include:

* Starting and joining discussions on the Swift Forums that are relevant for this area - we want to hear from you! 
...
*Need to describe other processes? Do it here*
